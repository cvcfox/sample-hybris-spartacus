 ...
 */
package com.toptal.commercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.toptal.commercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "toptalcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "toptalcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "toptalcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "toptalcommercewebservices.v2.description";
	private static final String TITLE = "toptalcommercewebservices.v2.title";
	private static final String VERSION = "toptalcommercewebservices.v2.version";
	private static final String LICENSE = "toptalcommercewebservices.v2.license";
	private static final String LICENSE_URL = "toptalcommercewebservices.v2.license.url";
